    ...
    public VentanaPersona() {
        ...
        this.btnAgregar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (validarFormulario()){
                    modelo.agregarPersona(new Persona(txtNombre.getText(), Integer.parseInt(txtEdad.getText())));
                lista.repaint();
                borrarFormulario();
                } else {
                    JOptionPane.showMessageDialog(null, "No puedes dejar vacios los campos", "Error del formulario",JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        this.lista.addItemListener(new ItemAdapter() {
            ...
            public void itemStateChanged(ItemEvent e) {
                //Causaba un error (investigar)
                //System.out.println((Persona)e.getItem());
            }
